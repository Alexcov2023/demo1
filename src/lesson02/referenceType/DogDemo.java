...
/*
        Dog myThirdDog = new Dog (3, 25.5);
        System.out.println(myThirdDog.age + ", " + myThirdDog.weight);
        System.out.println(myThirdDog);

        Dog my4Dog = new Dog(5, 30.4);
        System.out.println(my4Dog);
