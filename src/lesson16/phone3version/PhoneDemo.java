package lesson16.phone3version;
...
import lesson16.phone3version.phoneServices.PhoneCoverService;
import lesson16.phone3version.phoneServices.PhoneSimCardService;
import lesson16.phone3version.phoneServices.PhoneSmsService;
...
public class PhoneDemo {
    public static void main(String[] args) {
                ...
                SimCard simCard3 = new SimCard(33445566);
                ...
                // Проверка вставки сим карты во второй слот
                boolean insertedTwo = phoneSimCardService.insertSimCardTwo(phone, simCard2);
                if (insertedTwo) {
                 System.out.println("Sim карта вставлена во второй слот: " + phone);
                } else {
                System.out.println("Ошибка вставки Sim карты во второй слот.");
                }
               System.out.println("--------------------------------------------------------------------------------------------");
...
/*
      ...
      */
                // Проверка получения смс на вторую сим карту
                phoneSmsService.receivedSms(phone, "Hallo!");
                phoneSmsService.receivedSms(phone, "Wie geht es dir?");
                System.out.println("Полученные смс: " + Arrays.toString(phone.getSimCardTwo().getSms()));
                System.out.println("-------------------------------------------------------------------------------------------");
